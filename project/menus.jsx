// ---------------------------------------------------------------------------
// menus.jsx — Top-bar dropdown menus (File / View / Tools / Help).
// Click to open, click outside to close. Standard menu behaviour.
// ---------------------------------------------------------------------------
const { useState: useMenuState, useEffect: useMenuEffect, useRef: useMenuRef } = React;
...
// ---------------------------------------------------------------------------
// MenuBar — the full set of menus for the app.
// ---------------------------------------------------------------------------
function MenuBar(props) {
  ...
  const [openName, setOpenName] = useMenuState(null);
...
// ---------------------------------------------------------------------------
// StyleGuideModal — version + date.
// ---------------------------------------------------------------------------
function StyleGuideModal({ onClose }) {
  return (
    <div
      role="dialog"
      aria-modal="true"
...
Object.assign(window, { MenuBar, StyleGuideModal });
